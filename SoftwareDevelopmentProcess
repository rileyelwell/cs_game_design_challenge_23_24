...
Keep a large project backlog that contains everything we can think of to complete our
...
Assign items from our project backlog to our weekly iteration backlogs a week before the

iteration begins.

Work on the things in our current iteration during the week and update their status as we

work on them. We will continue this process until we have completed our project

backlog.

●

We will meet with the TA every Monday at 2:15 to discuss our progress and ask for
...
Meet as a group every Wednesday at 2:15 to discuss our progress and do group

assignments that require better communication.
...
**Version Control** GitHub and Unreal Source Control
...
**Test Framework** Unreal Engine 5
...
[Render](http://render.com)[ ](http://render.com)through CI/CD
